<template>
  <div class="main-box">
    ...
    <div class="table-button-box">
      <el-button  type="danger" icon="el-icon-goods" :disabled="multipleSelection.length ==  0" @click="handleMultiBuy">
        Buy
      </el-button>
    </div>
    <el-table  :data="list" row-key="id" :height="autoHeight"  border size="small" v-loading="listLoading" @selection-change="handleSelectionChange">
