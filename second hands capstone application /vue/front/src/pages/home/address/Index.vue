<template>
  <div>
    ...
    <el-table stripe :data="list" row-key="id" :height="autoHeight" border stripe size="small" v-loading="listLoading">
      ...
      <el-table-column prop="name" label="Name" :show-overflow-tooltip="true"  width="100"></el-table-column>
      <el-table-column prop="mobile" label="Mobile" width="200"></el-table-column>
