<template>
  <div class="mobile-score-container">
    <el-row :gutter="20">
      <el-col :span="24">
        <div style="width: 100%;background: #409EFF;border-radius: 5px;color:white;padding:5px 10px">
          <div style="font-size:14px;font-weight: bold">My score</div>
          <div style="margin-top: 5px;font-size: 30px;font-weight: bold">{{info.score}}</div>
        </div>
      </el-col>
      ...
      <el-col :span="24">
        <div class="task-box" >
          ...
          <el-checkbox-group v-model="daily" class="task-checkbox">
            <el-checkbox :label="1">Browse {{info.daily_score_desc}} 30 seconds</el-checkbox>
            <el-checkbox :label="2">Comment on two goods</el-checkbox>
            <el-checkbox :label="3">Successful sale of second-hand books </el-checkbox>
            <el-checkbox :label="4"> Successful sale of second-hand clothing</el-checkbox>
          </el-checkbox-group>
        </div>
      </el-col>
      <el-col :span="24">
        <div class="task-box" >
          ...
          <el-checkbox-group v-model="long" class="task-checkbox">
            <el-checkbox :label="11">Purchase goods 3 times</el-checkbox>
            <el-checkbox :label="12">Update user Avatar</el-checkbox>
            <el-checkbox :label="13">Update user nickname </el-checkbox>
          </el-checkbox-group>
        </div>
      </el-col>
